        ...
        <div className={`w-full max-w-md ${mounted ? 'animate-fadeIn' : 'opacity-0'}`}>
          ...
          <div className="mb-8 text-center">
            <div className="relative inline-flex items-center justify-center mb-6">
              <div className={`absolute inset-0 w-20 h-20 bg-gradient-to-r ${getTenantGradient()} rounded-full blur-xl opacity-60 animate-pulse`} />
              <div className={`relative w-16 h-16 rounded-full bg-gradient-to-r ${getTenantGradient()} shadow-2xl flex items-center justify-center`}>
                <Sparkles className="w-8 h-8 text-white" />
              </div>
            </div>
            <h1 className={`text-3xl font-bold bg-gradient-to-r ${getTenantGradient()} bg-clip-text text-transparent`}>
              Beauty Clinic
            </h1>
          ...
          <Card className="border-0 shadow-2xl backdrop-blur-sm bg-white/95">
            <div className={`h-2 bg-gradient-to-r ${getTenantGradient()}`} />
            ...
            <CardContent className="pb-8">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button
                  type="submit"
                  className={`w-full h-12 bg-gradient-to-r ${getTenantGradient()} hover:opacity-90 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]`}
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="h-11 rounded-xl hover:bg-gray-50 transition-all duration-300"
                    disabled={isLoading}
                  >
