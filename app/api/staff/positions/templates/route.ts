...
// GET - Fetch tenant staff position templates from tenant settings
export async function GET(req: NextRequest) {
  try {
    ...
    // Fetch tenant details to get staff_position_templates from settings
    ...
    // Return staff_position_templates from tenant settings
    const positions = tenantData_response.settings?.staff_position_templates || []
