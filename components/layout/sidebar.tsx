...
import { Home, Calendar, Users, Star, Settings, UserPlus, Menu, X, Sparkles, LogOut, Wallet, BarChart3, Clock, Power, Shield, Building } from "lucide-react"
  ...
  const menuGroups = useMemo(() => {
    const groups = [
      ...
      },
      {
        label: 'Business',
        items: [
          { name: 'Products', href: '/treatments', icon: Star, tourId: 'sidebar-treatments' },
