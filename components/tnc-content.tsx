  ...
  return (
    <div className="space-y-6 text-gray-700 leading-relaxed text-sm">
      ...
      <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r">
        <h3 className="font-bold text-amber-900 mb-2">PEMBERITAHUAN PENTING</h3>
      ...
      <div>
        ...
        <div className="space-y-3">
          <div>
            ...
            <p className="mb-1">Dengan membuat akun, mengakses, atau menggunakan Layanan Platform (baik Aplikasi Pelanggan maupun Konsol Admin), Anda menyatakan bahwa:</p>
          ...
          <div>
            <h4 className="font-semibold mb-1">2.2 Penerimaan Elektronik</h4>
            <p className="mb-1">Persetujuan Anda terhadap Syarat ini dapat dilakukan melalui:</p>
            <ul className="list-disc pl-5 space-y-1">
            ...
            <p className="mt-1">Penerimaan elektronik ini memiliki kekuatan hukum yang setara dengan tanda tangan manual sesuai UU No. 11 Tahun 2008 tentang Informasi dan Transaksi Elektronik (UU ITE) sebagaimana telah diubah dengan UU No. 19 Tahun 2016.</p>
          </div>
          <div>
            <h4 className="font-semibold mb-1">2.3 Bahasa</h4>
      ...
      {/* Continue with all remaining sections... Due to file length limit, I'll create this in a more efficient way */}

      <div className="text-center pt-6 border-t">
        <p className="text-gray-600">
          <strong>Dokumen lengkap tersedia. Untuk informasi lebih lanjut, hubungi reservaofficialig@gmail.com</strong>
        </p>
      </div>
