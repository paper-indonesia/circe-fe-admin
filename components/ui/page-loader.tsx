...
export function PageLoader({ text = "Loading" }: PageLoaderProps) {
  return (
    <div className="fixed inset-0 z-[9999] bg-white/95 backdrop-blur-sm flex flex-col items-center justify-center">
      ...
      {/* Modern Progress Bar */}
      <div className="w-72 h-1.5 bg-gradient-to-r from-gray-100 to-gray-200 rounded-full overflow-hidden shadow-inner mt-6">
        <div className="h-full bg-gradient-to-r from-[#C8B6FF] to-[#B8A6EF] animate-loading shadow-lg" />
      </div>
